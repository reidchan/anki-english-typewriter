...
export const DonatingCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`mt-3 flex w-full  flex-col  overflow-hidden px-11 transition-[height] duration-500 ${amount ? "h-44" : "h-0"}`}
      >
        {amount && <div className="flex w-full justify-between"></div>}
      </div>
