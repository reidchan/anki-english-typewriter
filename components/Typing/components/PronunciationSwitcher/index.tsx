...
import { LANG_PRON_MAP } from '@/lib/resources/soundResource'
import { currentDictInfoAtom, phoneticConfigAtom, pronunciationConfigAtom } from '@/lib/store'
import type { PronunciationType } from '@/lib/types'
import { PRONUNCIATION_PHONETIC_MAP } from '@/lib/types'
