...
import type { WordWithIndex } from "@/lib/types";
import type { LetterMistakes } from "@/lib/utils/db/record";
// import '@/utils/db/review-record'
import { mergeLetterMistake } from "@/lib/utils/db/utils";
...
export const typingReducer = (
  ...
  switch (action.type) {
    ...
    case TypingStateActionType.RESET: {
      const newState = structuredClone(initialState);
